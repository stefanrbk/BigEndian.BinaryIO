...
{
    [ComVisible(true)]
    public class BinaryReader : System.IO.BinaryReader, IDisposable
    {
        ...
        public override decimal ReadDecimal()
        {
            ...
            var lo = BinaryPrimitives.ReadInt32BigEndian(span.Slice(12));
            var mid = BinaryPrimitives.ReadInt32BigEndian(span.Slice(8));
            var hi = BinaryPrimitives.ReadInt32BigEndian(span.Slice(4));
